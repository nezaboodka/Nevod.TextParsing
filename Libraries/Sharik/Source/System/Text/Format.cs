...
namespace Sharik.Text
{
    ...
    public class Format
    {
        ...
        {
            return TryParseText(format, new Slice(text), target);
        }
        ...
        {
            return TryParseText(format, new Slice(text), target, members, ignoreUnknownTokens);
        }
        ...
        {
            return TryParseText(format, new Slice(text), target, fullMatch);
        }
        ...
        {
            return TryParseText(format, new Slice(text), target, fullMatch, setter);
        }
        ...
        {
            ParseText(format, new Slice(text), target);
        }
        ...
        public static void ParseText(string format, string text, object target, MemberTypes members,
            bool ignoreUnknownTokens)
        {
            ParseText(format, new Slice(text), target, members, ignoreUnknownTokens);
        }
        ...
        {
            ParseText(format, new Slice(text), target, fullMatch);
        }
        ...
        public static void ParseText(string format, string text, object target, bool fullMatch,
            Action<object, FormatToken> setter)
        {
            ParseText(format, new Slice(text), target, fullMatch, setter);
        }
        ...
        public static IEnumerable<FormatToken> ParseText(string format, string text, bool fullMatch,
            bool yieldTerms)
        {
            return ParseText(format, new Slice(text), fullMatch, yieldTerms);
        }
        ...
        {
            var position = 0;
            var read = ReaderUtil.GetReader(ParseFormat(format));
