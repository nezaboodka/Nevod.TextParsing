...
namespace Sharik.Text
{
    ...
    public sealed class Slice
    {
        ...
        internal Slice(string source, int position)
            : this(source, position, source.Length - position)
        {
        }

        internal Slice(string source, int position, int length)
        {
        ...
        internal Slice(Slice slice, int position)
            : this(slice, position, slice.Length - position)
        {
        }

        internal Slice(Slice slice, int position, int length)
        {
