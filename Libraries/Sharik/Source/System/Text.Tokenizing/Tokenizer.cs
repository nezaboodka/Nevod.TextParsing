...
namespace Sharik.Text.Tokenizing
{
    ...
    public class CustomTokenizer<TKind>
    {
        ...
        public string SourceText
        {
            ...
            {
                if (fPosition >= 0)
                    throw new Error(null, "cannot change SourceText property while tokenizing is in progress");
                SourceReader = ReaderUtil.GetReader(value);
                fSourceText = value;
            }
        }
        ...
        public Reader<char> SourceReader
        {
            ...
            {
                if (fPosition >= 0)
                    throw new Error(null, "cannot change Reader property while tokenizing is in progress");
                fSourceText = null;
                fSourceReader = value;
            }
        }
        ...
        protected Slice DoTake(TKind kind)
        {
            ...
            if (kind.Equals(t))
            {
                ...
                throw new Error(null, "{0} expected instead of {1}", kind, t);
            return result;
        }
